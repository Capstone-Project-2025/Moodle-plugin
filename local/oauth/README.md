# Modifications
The code file `locallib.php` has been modifed to make it runnable on Windows, because my Windows computer cannot run `$fp = fopen('/dev/urandom', 'rb')`. Otherwise, follow the instructions below.
* Moodle team members must follow the "Installation steps" section and provide to the DMOJ team:
  * The domain of Moodle: localhost
  * Client Identifier: dmoj
  * Client secret: 622b186cd4fd405d5451dffa6ca2104582606cb3e749cacd
* DMOJ team members, please follow the "How to use" section below, using the information provided above.
