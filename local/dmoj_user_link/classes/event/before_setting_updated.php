 ...
 */
namespace local_dmoj_user_link\event;
...
class before_setting_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_setting_before_updated', 'local_dmoj_user_link');
    }
    ...
    public function get_url() {
        return new \moodle_url('/admin/settings.php', ['section' => 'local_dmoj_user_link']);
    }
}