...
class qtype_programming_renderer extends qtype_renderer {
    ...
    public function formulation_and_controls(question_attempt $qa, question_display_options $options) {
        ...
        // Liste des langages avec ID et nom
$langs = [
...
document.getElementById("' . $submitbuttonid . '").addEventListener("click", function () {
    const textarea = document.getElementsByName("' . $inputname . '")[0];
    ...
    .then(text => {
        try {
            ...
            if (data.submission_id) {
                ...
                .then(resp => resp.json())
                .then(res => {
                    resultDiv.innerHTML += "<br><strong>Status:</strong> " + res.status +
                                           "<br><strong>Result:</strong> " + res.result +
