# Introduction
This is the "random0617-apcs" branch for Moodle version 3.11.18, website is called "OurMoodleSiteAPCS". It is used for all non-standard CS programs: "advanced", "high-quality" (Vietnamese: chương trình đề án, bao gồm chương trình tiên tiến và chương trình chất lượng cao).
