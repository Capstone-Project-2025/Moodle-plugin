...
$PAGE->set_url('/mod/progcontest/comment.php', array('attempt' => $attemptid, 'slot' => $slot));
...
if (!$attemptobj->is_finished()) {
    print_error('attemptclosed', 'progcontest');
}

// Check login and permissions.
require_login($attemptobj->get_course(), false, $attemptobj->get_cm());
$attemptobj->require_capability('mod/progcontest:grade');

// Print the page header.
$PAGE->set_pagelayout('popup');
$PAGE->set_title(get_string('manualgradequestion', 'progcontest', array(
...
<?php
echo '</form>';
$PAGE->requires->js_init_call('M.mod_progcontest.init_comment_popup', null, false, progcontest_get_js_module());
