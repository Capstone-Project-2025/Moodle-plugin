...
/**
 * This page deals with processing responses during an attempt at a progcontest.
 *
...
if ($attemptobj->is_finished()) {
    throw new moodle_progcontest_exception($attemptobj->get_progcontestobj(),
...
if ($status == progcontest_attempt::OVERDUE) {
    redirect($attemptobj->summary_url());
} else if ($status == progcontest_attempt::IN_PROGRESS) {
    redirect($nexturl);
} else {
