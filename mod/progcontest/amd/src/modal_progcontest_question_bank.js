...
function(
    ...
    var SELECTORS = {
        ADD_TO_progcontest_CONTAINER: 'td.addtoprogcontestaction',
        ANCHOR: 'a[href]',
     ...
     */
    var ModalProgrammingcontestQuestionBank = function(root) {
    ...
    ModalProgrammingcontestQuestionBank.TYPE = 'mod_progcontest-progcontest-question-bank';
    ModalProgrammingcontestQuestionBank.prototype = Object.create(Modal.prototype);
    ModalProgrammingcontestQuestionBank.prototype.constructor = ModalProgrammingcontestQuestionBank;
     ...
     * @param {int} id
     */
    ModalProgrammingcontestQuestionBank.prototype.setContextId = function(id) {
        this.contextId = id;
    };
     ...
     * @return {int}
     */
    ModalProgrammingcontestQuestionBank.prototype.getContextId = function() {
        return this.contextId;
    };

    /**
     * Set the id of the page that the question should be added to
     * when the user clicks the add to progcontest link.
     *
     * @method setAddOnPageId
     * @param {int} id
     */
    ModalProgrammingcontestQuestionBank.prototype.setAddOnPageId = function(id) {
        this.addOnPageId = id;
    };
     ...
     * @return {int}
     */
    ModalProgrammingcontestQuestionBank.prototype.getAddOnPageId = function() {
     ...
     * @return {void}
     */
    ModalProgrammingcontestQuestionBank.prototype.show = function() {
     ...
     */
    ModalProgrammingcontestQuestionBank.prototype.reloadBodyContent = function(queryString) {
        // Load the question bank fragment to be displayed in the modal.
        var promise = Fragment.loadFragment(
            'mod_progcontest',
            'progcontest_question_bank',
            this.getContextId(),
            {
     ...
     *
     * @method handleAddToProgrammingcontestEvent
     * @param {event} e A JavaScript event
     * @param {object} anchorElement The anchor element that was triggered
     */
    ModalProgrammingcontestQuestionBank.prototype.handleAddToProgrammingcontestEvent = function(e, anchorElement) {
     ...
     * @param {object} anchorElement The anchor element that was triggered
     */
    ModalProgrammingcontestQuestionBank.prototype.handlePreviewContainerEvent = function(e, anchorElement) {
        var popupOptions = [
            'height=600',
            'width=800',
            'top=0',
     ...
     * @param {event} e A JavaScript event
     */
    ModalProgrammingcontestQuestionBank.prototype.handleDisplayOptionFormEvent = function(e) {
     ...
     *      - The progcontest category select box
     ...
     */
    ModalProgrammingcontestQuestionBank.prototype.registerDisplayOptionListeners = function() {
        // Listen for changes to the display options form.
     ...
     */
    ModalProgrammingcontestQuestionBank.prototype.registerEventListeners = function() {
        ...
        this.getModal().on('submit', SELECTORS.ADD_QUESTIONS_FORM, function(e) {
            // If the user clicks on the "Add selected questions to the progcontest" button to add some questions to the page
        ...
        this.getModal().on('click', SELECTORS.ANCHOR, function(e) {
            ...
            // If the anchor element was the add to progcontest link.
            if (anchorElement.closest(SELECTORS.ADD_TO_progcontest_CONTAINER).length) {
                this.handleAddToProgrammingcontestEvent(e, anchorElement);
                return;
            }
    ...
    if (!registered) {
        ModalRegistry.register(
            ModalProgrammingcontestQuestionBank.TYPE,
            ModalProgrammingcontestQuestionBank,
            'core/modal'
        );
    ...
    return ModalProgrammingcontestQuestionBank;
});
