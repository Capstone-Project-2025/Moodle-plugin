 ...
 *
 * @module     mod_progcontest/modal_add_random_question
...
function(
    ...
    ModalAddRandomQuestion.TYPE = 'mod_progcontest-progcontest-add-random-question';
    ...
    if (!registered) {
        ModalRegistry.register(
            ...
            'mod_progcontest/modal_add_random_question'
        );
