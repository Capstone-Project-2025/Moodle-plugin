 ...
 *
 * This is also responsible for opening the pop-up window, if the progcontest requires to be in one.
 *
 * @module    mod_progcontest/preflightcheck
...
define(['jquery', 'core/yui'], function($, Y) {
    ...
    /**
     * @alias module:mod_progcontest/preflightcheck
     */
    var t = {
         ...
         * @param {String} popupoptions If not null, the progcontest should be launced in a pop-up.
         */
            ...
            Y.use('moodle-core-notification', function() {
                if (Y.one(confirmationForm)) {
                    t.confirmDialogue = new M.core.dialogue({
                        ...
                        modal: true,
                        width: null,
                        extraClasses: ['mod_progcontest_preflight_popup']
                    });
                ...
                if (popupoptions) {
                    Y.one(finalStartButton).on('click', t.launchProgrammingcontestPopup, t, popupoptions);
                }
            });
        },
        ...
        /**
         * Event handler for the progcontest start attempt button.
         * @param {Event} e the event being responded to
         * @param {Object} popupoptions
         */
        launchProgrammingcontestPopup: function(e, popupoptions) {
            e.halt();
