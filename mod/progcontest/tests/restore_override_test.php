...
class restore_override_test extends \restore_date_testcase {
    ...
    public function test_restore_overrides() {
        ...
        $progcontestgen = $this->getDataGenerator()->get_plugin_generator('mod_progcontest');
        $progcontest = $progcontestgen->create_instance(['course' => $course->id]);
        ...
        $DB->insert_record('progcontest_overrides', $groupoverride1);
        ...
        $DB->insert_record('progcontest_overrides', $groupoverride2);

        // Current progcontest overrides.
        $overrides = $DB->get_records('progcontest_overrides', ['progcontest' => $progcontest->id]);
        ...
        $DB->insert_record('progcontest_overrides', $useroverride);
        ...
        $overrides = $DB->get_records('progcontest_overrides', ['progcontest' => $newprogcontest->id]);
