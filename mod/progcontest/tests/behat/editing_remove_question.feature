@mod @mod_progcontest
Feature: Edit progcontest page - remove questions
  ...
  Scenario: Delete questions by clicking on the delete icon.
    ...
    And I should see "This progcontest is open"

    # Delete last question in last page. Page contains multiple questions
    When I delete "Question C" in the progcontest by clicking the delete icon
    Then I should see "Question A" on progcontest page "1"
    And I should see "Question B" on progcontest page "1"
    And I should not see "Question C" on progcontest page "2"
    ...
    Then I should see "Question B" on progcontest page "2"
    And the "Remove" page break icon after question "Question A" should exist
    And I delete "Question A" in the progcontest by clicking the delete icon
    Then I should see "Question B" on progcontest page "1"
    And I should not see "Page 2"
    And I should not see "Question A" on progcontest page "2"
  ...
  @javascript
  Scenario: Can delete the last question in a progcontest.
    Given the following "questions" exist:
      | questioncategory | qtype     | name       | questiontext        |
      | Test questions   | truefalse | Question A | This is question 01 |
    And progcontest "Programmingcontest 1" contains the following questions:
      ...
      | Question A | 1    |
    And I am on the "Programmingcontest 1" "mod_progcontest > Edit" page
    When I delete "Question A" in the progcontest by clicking the delete icon
