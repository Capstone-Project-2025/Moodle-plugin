...
Feature: Adding random questions to a progcontest based on category and tags
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | progcontest       | Programmingcontest 1 | Programmingcontest 1 for testing the Add random question form | C1     | progcontest1    |
  ...
  Scenario: A random question can be added to the progcontest
    Given I am on the "Programmingcontest 1" "mod_progcontest > Edit" page logged in as "teacher1"
    When I open the "last" add to progcontest menu
    And I follow "a random question"
    And I set the field "Tags" to "foo"
    And I press "Add random question"
    Then I should see "Random (Questions Category 1, tags: foo)" on progcontest page "1"
  ...
  Scenario: A random question can be added to the progcontest by creating a new category
    Given I am on the "Programmingcontest 1" "mod_progcontest > Edit" page logged in as "teacher1"
    When I open the "last" add to progcontest menu
    And I follow "a random question"
    ...
    And I set the following fields to these values:
      ...
      | Parent category |  Top for Programmingcontest 1     |
    And I press "Create category and add random question"
    Then I should see "Random (New Random category)" on progcontest page "1"
