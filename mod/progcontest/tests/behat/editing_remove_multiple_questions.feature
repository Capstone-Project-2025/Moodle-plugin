@mod @mod_progcontest
Feature: Edit progcontest page - remove multiple questions
  In order to change the layout of a progcontest I built efficiently
  As a teacher
  ...
  # Confirm the starting point.
    Then I should see "Question A" on progcontest page "1"
    And I should see "Question B" on progcontest page "2"
    And I should see "Question C" on progcontest page "2"
    And I should see "Total of marks: 3.00"
    And I should see "Questions: 3"
    And I should see "This progcontest is open"
  ...
  # Delete first question in first page. Page contains multiple questions. No reordering.
    ...
    Then I should not see "Question A" on progcontest page "1"
    And I should see "Question B" on progcontest page "1"
  ...
  Scenario: Delete all questions by checking select all.
    ...
    Then I should not see "Question A" on progcontest page "1"
    And I should not see "Question B" on progcontest page "1"
    And I should not see "Question C" on progcontest page "2"
  ...
  Scenario: Delete multiple questions from sections
    ...
    Then I should see "Question A" on progcontest page "1"
    And I should see "Question B" on progcontest page "2"
    And I should see "Question D" on progcontest page "3"
