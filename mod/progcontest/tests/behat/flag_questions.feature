@mod @mod_progcontest
Feature: Flag progcontest questions
  As a student
  In order to flag a progcontest questions
  ...
  @javascript
  Scenario: Flag a progcontest during and after progcontest attempt
    Given I am on the "Programmingcontest 1" "progcontest activity" page logged in as student1
    ...
    And I am on the "Programmingcontest 1" "mod_progcontest > Grades report" page logged in as teacher1
    And "Flagged" "icon" should exist in the "Student 1" "table_row"
    And I am on the "Programmingcontest 1" "mod_progcontest > Responses report" page
    And "Flagged" "icon" should exist in the "Student 1" "table_row"
