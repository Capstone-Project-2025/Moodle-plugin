@mod @mod_progcontest
Feature: Attempt a progcontest where some questions require that the previous question has been answered.
  In order to complete a progcontest where questions require previous ones to be complete
  As a student
  ...
  Scenario: A question that requires the previous one is initally blocked
    ...
    And I log out
    And I am on the "Programmingcontest 1 > student > Attempt 1" "mod_progcontest > Attempt review" page logged in as "teacher"
  ...
  @javascript
  Scenario: After progcontest submitted, all questions show on the review page
    Given the following "questions" exist:
      | questioncategory | qtype       | name  | questiontext    |
      | Test questions   | truefalse   | TF1   | First question  |
      | Test questions   | truefalse   | TF2   | Second question |
  ...
  @javascript
  Scenario: A questions cannot be blocked in a deferred feedback progcontest (despite what is set in the DB).
    Given the following "questions" exist:
      | questioncategory | qtype       | name  | questiontext    |
      | Test questions   | truefalse   | TF1   | First question  |
      | Test questions   | truefalse   | TF2   | Second question |
  ...
  @javascript
  Scenario: A questions cannot be blocked in sequential progcontest (despite what is set in the DB).
    Given the following "questions" exist:
      | questioncategory | qtype       | name  | questiontext    |
      | Test questions   | truefalse   | TF1   | First question  |
      | Test questions   | truefalse   | TF2   | Second question |
