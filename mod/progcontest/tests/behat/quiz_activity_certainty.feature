@mod @mod_progcontest
Feature: Set a progcontest with certainty-based marking
  As a teacher
  In order to set a a progcontest with certainty-based marking
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | progcontest     | Programmingcontest 1 | C1     |
  ...
  @javascript
  Scenario: Teacher can set a progcontest with certainty-based marking
    Given I am on the "Programmingcontest 1" "progcontest activity editing" page logged in as teacher1
    And I set the following fields to these values:
      | preferredbehaviour | immediatecbm |
    And I press "Save and return to course"
    And I am on the "Programmingcontest 1" "progcontest activity" page logged in as student1
    When I press "Attempt progcontest"
    ...
    And the following should exist in the "progcontestreviewsummary" table:
      | -1-              | -2-                                                                                                                 |
      | Marks            | 2.00/3.00                                                                                                           |
    ...
    # As teacher, confirm same progcontest contents
    And I am on the "Programmingcontest 1" "progcontest activity" page logged in as teacher1
    And I press "Preview progcontest"
    And I should see "C=1 (Unsure: <67%)"
    And I should see "C=2 (Mid: >67%)"
    And I should see "C=3 (Quite sure: >80%)"
    And I am on the "Programmingcontest 1" "mod_progcontest > Grades report" page
