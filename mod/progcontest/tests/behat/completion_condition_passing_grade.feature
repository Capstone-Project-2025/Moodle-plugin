...
Feature: Set a progcontest to be marked complete when the student passes
  In order to ensure a student has learned the material before being marked complete
  As a teacher
  I need to set a progcontest to complete when the student recieves a passing grade
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | progcontest     | Test progcontest name | C1     | progcontest1    | 4        | 5.00      | 2          | 1                  | 1              | 1              |
  ...
  Scenario: student1 passes on the first try
    ...
    And the "Receive a pass grade" completion condition of "Test progcontest name" is displayed as "todo"
    And the "View" completion condition of "Test progcontest name" is displayed as "todo"
    And user "student1" has attempted "Test progcontest name" with responses:
      | slot | response |
      |   1  | True     |
    And I follow "Test progcontest name"
    Then the "Receive a grade" completion condition of "Test progcontest name" is displayed as "done"
    And the "Receive a pass grade" completion condition of "Test progcontest name" is displayed as "done"
  ...
  Scenario Outline: Verify that gradepass, together with completionpassgrade are validated correctly
    ...
    And the following "activity" exist:
      ...
      | progcontest     | Oh, grades, passgrades and floats| C1     | ohgrades | <gradepass>| 2          | <completionpass> |
    When  I am on the "ohgrades" "progcontest activity editing" page logged in as "teacher1"
