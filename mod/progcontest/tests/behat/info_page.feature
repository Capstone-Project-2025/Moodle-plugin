@mod @mod_progcontest
Feature: Display of information before starting a progcontest
  As a student
  In order to start a progcontest with confidence
  I need information about the progcontest settings before I start an attempt
  ...
  Scenario: Check the pass grade is displayed
    Given the following "activities" exist:
      ...
      | progcontest       | Programmingcontest 1 | Programmingcontest 1 description | C1     | progcontest1    | 60.00     |
