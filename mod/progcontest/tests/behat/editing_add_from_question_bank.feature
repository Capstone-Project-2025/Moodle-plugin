@mod @mod_progcontest @javascript
Feature: Adding questions to a progcontest from the question bank
  ...
  Scenario: Questions are added in the right place with multiple sections
    ...
    And I log in as "teacher1"
    And I am on the "Programmingcontest 1" "mod_progcontest > Edit" page
    When I open the "Page 1" add to progcontest menu
    And I follow "from question bank"
    And I set the field with xpath "//tr[contains(normalize-space(.), 'question 03 name')]//input[@type='checkbox']" to "1"
    And I click on "Add selected questions to the progcontest" "button"
    Then I should see "question 03 name" on progcontest page "1"
    And I should see "question 01 name" before "question 03 name" on the edit progcontest page

  Scenario: Add several selected questions from the question bank
    Given I am on the "Programmingcontest 1" "mod_progcontest > Edit" page logged in as "teacher1"
    ...
    And I press "Add selected questions to the progcontest"
    Then I should see "question 01 name" on progcontest page "1"
    And I should see "question 02 name" on progcontest page "2"
