@mod @mod_progcontest
Feature: Programmingcontest group override
  In order to grant a group special access to a progcontest
  As a teacher
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | progcontest     | Test progcontest | Test progcontest description | C1     | progcontest1    | 1         |

  Scenario: Override Group 1 as teacher of Group 1
    Given the following "permission overrides" exist:
      | capability                  | permission | role           | contextlevel | reference |
      | moodle/site:accessallgroups | Prevent    | editingteacher | Course       | C1        |
    When I am on the "Test progcontest" "mod_progcontest > Group overrides" page logged in as "teacher1"
  ...
  Scenario: Override Group 1 as teacher in no group
    Given the following "permission overrides" exist:
      | capability                  | permission | role           | contextlevel | reference |
      | moodle/site:accessallgroups | Prevent    | editingteacher | Course       | C1        |
    When I am on the "Test progcontest" "mod_progcontest > Group overrides" page logged in as "teacher3"
  ...
  Scenario: A teacher with accessallgroups permission should see all group overrides
    Given the following "mod_progcontest > group overrides" exist:
      ...
      | Test progcontest | G1    | 2        |
      | Test progcontest | G2    | 2        |
    When I am on the "Test progcontest" "mod_progcontest > View" page logged in as "teacher1"
  ...
  Scenario: A teacher without accessallgroups permission should only see the group overrides within his/her groups, when the activity's group mode is "separate groups"
    Given the following "permission overrides" exist:
      | capability                  | permission | role           | contextlevel | reference |
      | moodle/site:accessallgroups | Prevent    | editingteacher | Course       | C1        |
    And the following "mod_progcontest > group overrides" exist:
      | progcontest      | group | attempts |
      | Test progcontest | G1    | 2        |
      | Test progcontest | G2    | 2        |
    When I am on the "Test progcontest" "mod_progcontest > View" page logged in as "teacher1"
  ...
  Scenario: A non-editing teacher can see the overrides, but not change them
    Given the following "mod_progcontest > group overrides" exist:
      ...
      | Test progcontest | G1    | 2        |
      | Test progcontest | G2    | 2        |
    When I am on the "Test progcontest" "mod_progcontest > Group overrides" page logged in as "helper"
    Then "Group 1" "table_row" should exist
    And "Group 2" "table_row" should exist
