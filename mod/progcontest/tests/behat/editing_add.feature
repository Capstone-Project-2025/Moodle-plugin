@mod @mod_progcontest
Feature: Edit progcontest page - adding things
  In order to build the progcontest I want my students to attempt
  As a teacher
  I need to be able to add questions to the progcontest.
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | progcontest       | Programmingcontest 1 | Programmingcontest 1 for testing the Add menu | C1     | progcontest1    |
    And I am on the "Programmingcontest 1" "mod_progcontest > Edit" page logged in as "teacher1"
    And I should see "Editing progcontest: Programmingcontest 1"

  @javascript
  Scenario: Add some new question to the progcontest using '+ a new question' options of the 'Add' menu.
    When I open the "last" add to progcontest menu
    ...
    Then I should see "Editing progcontest: Programmingcontest 1"
    And I should see "Essay 01 new" on progcontest page "1"

    And I open the "Page 1" add to progcontest menu
    And I follow "a new question"
    And I set the field "item_qtype_essay" to "1"
    And I press "submitbutton"
    Then I should see "Adding an Essay question"
    ...
    Then I should see "Editing progcontest: Programmingcontest 1"
    And I should see "Essay 01 new" on progcontest page "1"
    And I should see "Essay 02 new" on progcontest page "1"
    ...
    And I should see "Essay 01 new" on progcontest page "1"
    And I should see "Essay 02 new" on progcontest page "1"
    And I should see "Essay 03 new" on progcontest page "1"
    ...
    And I should see "Essay 02 new" on progcontest page "1"
    And I should see "Essay 03 new" on progcontest page "1"
    And I should see "Essay 04 new" on progcontest page "1"
    ...
    And I should see "Essay 01 new" on progcontest page "1"
    And I should see "Essay 02 new" on progcontest page "1"
    And I should see "Essay 03 new" on progcontest page "2"
    And I should see "Essay 04 new" on progcontest page "2"

    # Add a question to page 2.
    When I open the "Page 2" add to progcontest menu
    ...
    And I should see "Essay 03 new" on progcontest page "2"
    And I should see "Essay 04 new" on progcontest page "2"
    And I should see "Essay for page 2" on progcontest page "2"

  @javascript
  Scenario: Add questions from question bank to the progcontest. In order to be able to
      add questions from question bank to the progcontest, first we create some new questions
    ...
    And I am on the "Programmingcontest 1" "mod_progcontest > Edit" page
    And I open the "last" add to progcontest menu
    And I follow "from question bank"
    Then the "Add selected questions to the progcontest" "button" should be disabled
    And I click on "Essay 03" "checkbox"
    Then the "Add selected questions to the progcontest" "button" should be enabled
    And I click on "Add to progcontest" "link" in the "Essay 03" "table_row"
    Then I should see "Editing progcontest: Programmingcontest 1"
    And I should see "Essay 03" on progcontest page "1"

    # Add Essay 01 from question bank.
    And I open the "Page 1" add to progcontest menu
    And I follow "from question bank"
    And I click on "Add to progcontest" "link" in the "Essay 01" "table_row"
    Then I should see "Editing progcontest: Programmingcontest 1"
    And I should see "Essay 03" on progcontest page "1"
    And I should see "Essay 01" on progcontest page "1"
    ...
    And I should see "Select a category"
    And I set the field "Select a category" to "Subcat 1"
    And I click on "Add to progcontest" "link" in the "Essay 02" "table_row"
    Then I should see "Editing progcontest: Programmingcontest 1"
    And I should see "Essay 03" on progcontest page "1"
    And I should see "Essay 01" on progcontest page "1"
    And I should see "Essay 02" on progcontest page "1"
    ...
    And I should see "Essay 01" on progcontest page "1"
    And I should see "Essay 02" on progcontest page "1"
    And I should see "Random" on progcontest page "1"
    ...
    When I click on "Go" "button" in the "Repaginate" "dialogue"
    And I should see "Essay 03" on progcontest page "1"
    And I should see "Essay 01" on progcontest page "2"
    And I should see "Essay 02" on progcontest page "3"
    And I should see "Random" on progcontest page "4"

    # Add a random question to page 4.
    And I open the "Page 4" add to progcontest menu
    And I choose "a new question" in the open action menu
    And I set the field "item_qtype_essay" to "1"
    And I press "submitbutton"
    Then I should see "Adding an Essay question"
    ...
    And I should see "Essay 02" on progcontest page "3"
    And I should see "Random" on progcontest page "4"
    And I should see "Essay for page 4" on progcontest page "4"
