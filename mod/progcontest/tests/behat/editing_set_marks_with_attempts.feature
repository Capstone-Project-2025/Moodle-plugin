@mod @mod_progcontest
Feature: Edit progcontest marks with attempts
  In order to create a progcontest that awards marks the way I want
  As a teacher
  I must be able to set the marks I want on the Edit progcontest page (even after the progcontest has been attempted).
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | progcontest       | Programmingcontest 1 | C1     | progcontest1    | 20    | 2             | -1                    |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I add a "True/False" question to the "Programmingcontest 1" progcontest with:
    ...
    And I add a "True/False" question to the "Programmingcontest 1" progcontest with:
      ...
      | Default mark  | 3.0             |
    And I log out
    And I am on the "Programmingcontest 1" "mod_progcontest > View" page logged in as "student1"
  ...
  @javascript
  Scenario: Verify the number of decimal places shown is what the progcontest settings say it should be.
    ...
    When I am on the "Programmingcontest 1" "progcontest activity editing" page
