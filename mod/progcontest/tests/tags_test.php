...
use mod_progcontest\question\bank\qbank_helper;
use progcontest;

/**
 * Class mod_progcontest_tags_testcase
 * Class for tests related to usage of question tags in progcontestzes.
 *
...
class tags_test extends \advanced_testcase {
    public function test_restore_random_question_by_tag() {
        ...
        get_file_packer('application/vnd.moodle.backup')->extract_to_pathname(
                __DIR__ . "/fixtures/random_by_tag_progcontest.mbz", $backuppath);
        ...
        $progcontest = array_values($modinfo->get_instances_of('progcontest'))[0];
        $progcontestobj = progcontest::create($progcontest->instance);
        ...
        $slottags = progcontest_retrieve_slot_tags($question->slotid);
