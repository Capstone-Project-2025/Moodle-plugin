...
/**
 * Contains unit tests for mod_progcontest\dates.
 *
...
/**
 * Class for unit testing mod_progcontest\dates.
 *
 * @copyright 2021 Shamim Rezaie <shamim@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dates_test extends advanced_testcase {
     ...
     * @param int|null $timeopen Time of opening the progcontest.
     * @param int|null $timeclose Time of closing the progcontest.
     * @param int|null $usertimeopen The user override for opening the progcontest.
     * @param int|null $usertimeclose The user override for closing the progcontest.
     * @param int|null $grouptimeopen The group override for opening the progcontest.
     * @param int|null $grouptimeclose The group override for closing the progcontest.
