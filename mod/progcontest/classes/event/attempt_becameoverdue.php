...
/**
 * The mod_progcontest attempt became overdue event.
 *
...
/**
 * The mod_progcontest attempt became overdue event class.
 *
...
class attempt_becameoverdue extends \core\event\base {
    ...
    public function get_description() {
        return "The progcontest attempt with id '$this->objectid' belonging to the progcontest with course module id '$this->contextinstanceid' " .
    ...
    public static function get_name() {
        return get_string('eventprogcontestattempttimelimitexceeded', 'mod_progcontest');
    }
    ...
    static public function get_legacy_eventname() {
        return 'progcontest_attempt_overdue';
    }
