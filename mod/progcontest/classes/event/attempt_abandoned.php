...
/**
 * The mod_progcontest attempt abandoned event.
 *
...
/**
 * The mod_progcontest attempt abandoned event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int submitterid: id of submitter (null when trigged by CLI script).
 *      - int progcontestid: (optional) id of the progcontest.
 * }
 *
 * @package    mod_progcontest
 * @since      Moodle 2.6
...
class attempt_abandoned extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has had their attempt with id '$this->objectid' marked as abandoned " .
            "for the progcontest with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventprogcontestattemptabandoned', 'mod_progcontest');
    }
    ...
    static public function get_legacy_eventname() {
        return 'progcontest_attempt_abandoned';
    }
