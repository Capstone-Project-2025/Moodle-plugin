...
/**
 * Admin settings class for the progcontest review options.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_progcontest_admin_review_setting extends admin_setting {
    /**
     * @var integer should match the constants defined in
     * {@link mod_progcontest_display_options}. Copied for performance reasons.
     */
    ...
    /**
     * This should match {@link mod_progcontest_mod_form::$reviewfields} but copied
     * here because generating the admin tree needs to be fast.
     * @return array
     */
    public static function fields() {
        return array(
            'attempt'          => get_string('theattempt', 'progcontest'),
            ...
            'overallfeedback'  => get_string('overallfeedback', 'progcontest'),
        );
    }
    ...
    protected static function times() {
        return array(
            self::DURING            => get_string('reviewduring', 'progcontest'),
            self::IMMEDIATELY_AFTER => get_string('reviewimmediately', 'progcontest'),
            self::LATER_WHILE_OPEN  => get_string('reviewopen', 'progcontest'),
            self::AFTER_CLOSE       => get_string('reviewclosed', 'progcontest'),
        );
    }
    ...
    public function output_html($data, $query = '') {
        ...
        return format_admin_setting($this, $this->visiblename, $return,
                $this->description, true, '', get_string('everythingon', 'progcontest'), $query);
    }
}
