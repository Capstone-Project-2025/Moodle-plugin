...
/**
 * Strings for component 'progcontest_statistics', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['backtoprogcontestreport'] = 'Back to main statistics report page.';
$string['calculatefrom'] = 'Calculate statistics from';
$string['calculatingallstats'] = 'Calculating statistics for progcontest, questions and analysing response data';
...
$string['errorpowers'] = 'Error fetching data to calculate variance for progcontest grades';
...
$string['negcovar_help'] = 'This question\'s grade for this set of attempts on the progcontest varies in an opposite way to the overall attempt grade. This means overall attempt grade tends to be below average when the grade for this question is above average and vice-versa.

Our equation for effective question weight cannot be calculated in this case. The calculations for effective question weight for other questions in this progcontest are the effective question weight for these questions if the highlighted questions with a negative covariance are given a maximum grade of zero.

If you edit a progcontest and give these question(s) with negative covariance a max grade of zero then the effective question weight of these questions will be zero and the real effective question weight of other questions will be as calculated now.';
$string['nogradedattempts'] = 'No attempts have been made at this progcontest, or all attempts have questions that need manual grading.';
...
$string['privacy:metadata'] = 'Although the Programmingcontest Statistics plugin has database tables, the data is aggregate data and does not describe a unique indidividual.';
...
$string['progconteststatisticscleanuptask'] = 'Clean up old progcontest statistics cache records';
$string['questionstatsfilename'] = 'questionstats';
$string['questiontype'] = 'Question type';
$string['progcontestinformation'] = 'Programmingcontest information';
$string['progcontestname'] = 'Programmingcontest name';
$string['progcontestoverallstatistics'] = 'Programmingcontest overall statistics';
$string['progconteststructureanalysis'] = 'Programmingcontest structure analysis';
...
$string['statsfor'] = 'Programmingcontest statistics (for {$a})';
