...
/**
 * Standard plugin entry points of the progcontest statistics report.
 *
 ...
 * @package  progcontest_statistics
 * @category files
 * @param context $previewcontext the progcontest context
 ...
 */
function progcontest_statistics_question_preview_pluginfile($previewcontext, $questionid,
    ...
    require_capability('progcontest/statistics:view', $context);
