...
use progcontest_grading\privacy\provider;
...
class provider_test extends \core_privacy\tests\provider_testcase {
    ...
    public function test_preference_bool_true() {
        ...
        set_user_preference('progcontest_grading_pagesize', 42);
        set_user_preference('progcontest_grading_order', 'random');
        ...
        $preferences = $writer->get_user_preferences('progcontest_grading');
