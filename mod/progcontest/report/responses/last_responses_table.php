...
/**
 * This file defines the progcontest responses table for showing last try at question.
 *
...
/**
 * This is a table subclass for displaying the progcontest responses report.
 *
 * @copyright 2008 Jean-Michel Vedrine
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class progcontest_last_responses_table extends progcontest_attempts_report_table {
     ...
     * @param progcontest_responses_options $options
     * @param \core\dml\sql_join $groupstudentsjoins
     * @param \core\dml\sql_join $studentsjoins
     * @param array $questions
     * @param moodle_url $reporturl
     */
    public function __construct($progcontest, $context, $qmsubselect, progcontest_responses_options $options,
            \core\dml\sql_join $groupstudentsjoins, \core\dml\sql_join $studentsjoins, $questions, $reporturl) {
        parent::__construct('mod-progcontest-report-responses-report', $progcontest, $context,
    ...
    public function col_sumgrades($attempt) {
        ...
        $gradehtml = '<a href="review.php?q=' . $this->progcontest->id . '&amp;attempt=' .
