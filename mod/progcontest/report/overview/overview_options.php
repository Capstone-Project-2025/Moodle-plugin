...
/**
 * Class to store the options for a {@link progcontest_overview_report}.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class progcontest_overview_options extends mod_progcontest_attempts_report_options {
    ...
    public function setup_from_user_preferences() {
        ...
        $this->slotmarks = get_user_preferences('progcontest_overview_slotmarks', $this->slotmarks);
    }

    public function update_user_preferences() {
        parent::update_user_preferences();

        if (progcontest_has_grades($this->progcontest)) {
            set_user_preference('progcontest_overview_slotmarks', $this->slotmarks);
        }
    }
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_any_capability(
                array('mod/progcontest:regrade', 'mod/progcontest:deleteattempts'), context_module::instance($this->cm->id))
