@mod @mod_progcontest @progcontest @progcontest_overview
Feature: Basic use of the Grades report
  In order to easily get an overview of progcontest attempts
  As a teacher
  ...
  Scenario: Using the Grades report
    ...
    When I am on the "Programmingcontest 1" "progcontest activity" page logged in as teacher1
    ...
    And I set the field "Attempts from" to "all users who have attempted the progcontest"
    And I press "Show report"
    # Check student1's grade
    And I should see "25.00" in the "S1 Student1" "table_row"
    # Check student2's grade
