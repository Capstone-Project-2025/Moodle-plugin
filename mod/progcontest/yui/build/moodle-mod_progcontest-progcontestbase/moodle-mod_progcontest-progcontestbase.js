YUI.add('moodle-mod_progcontest-progcontestbase', function (Y, NAME) {

/**
 * The progcontestbase class to provide shared functionality to Modules within Moodle.
 *
 * @module moodle-mod_progcontest-progcontestbase
 */
var QUIZBASENAME = 'mod_progcontest-progcontestbase';

var Progcontestbase = function() {
    Progcontestbase.superclass.constructor.apply(this, arguments);
};
 ...
 * @constructor
 */
Y.extend(Progcontestbase, Y.Base, {
    // Registered Modules
    registermodules: [],
...
M.mod_progcontest.progcontestbase = M.mod_progcontest.progcontestbase || new Progcontestbase();

// Abstract functions that needs to be defined per format (course/format/somename/format.js)
M.mod_progcontest.edit = M.mod_progcontest.edit || {};
 ...
 */
M.mod_progcontest.edit.swap_sections = function(Y, node1, node2) {
    var CSS = {
 ...
 * @return void
 */
M.mod_progcontest.edit.process_sections = function(Y, sectionlist, response, sectionfrom, sectionto) {
    var CSS = {
