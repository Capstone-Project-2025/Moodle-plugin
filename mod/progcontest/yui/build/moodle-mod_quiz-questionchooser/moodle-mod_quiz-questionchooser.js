YUI.add('moodle-mod_progcontest-questionchooser', function (Y, NAME) {
    ...
    /**
     * The questionchooser class is responsible for instantiating and displaying
     * the question chooser when viewing a progcontest in editing mode.
     *
