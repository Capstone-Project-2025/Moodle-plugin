...
/**
 * Strings for component 'progcontest', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['accessnoticesheader'] = 'You can preview this progcontest, but if this were a real attempt, you would be blocked because:';
$string['action'] = 'Action';
$string['activityoverview'] = 'You have progcontestzes that are due';
$string['adaptive'] = 'Adaptive mode';
$string['adaptive_help'] = 'If enabled, multiple responses to a question are allowed within the same attempt at the progcontest. So for example if a response is marked as incorrect, the student will be allowed to try again immediately. However, depending on the "Apply penalties" setting, a penalty will usually be subtracted for each wrong attempt.';
$string['add'] = 'Add';
$string['addaquestion'] = 'a new question';
$string['addasection'] = 'a new section heading';
$string['addarandomquestion'] = 'a random question';
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the progcontest. This means that different students are likely to get a different selection of questions, and when a progcontest allows multiple attempts then each attempt is likely to contain a new selection of questions.';
...
$string['addingquestions'] = '<p>This side of the page is where you manage your database of questions. Questions are stored in categories to help you keep them organised, and can be used by any progcontest in your course or even other courses if you choose to \'publish\' them.</p>
<p>After you select or create a question category you will be able to create or edit questions. You can select any of these questions to add to your progcontest over on the other side of this page.</p>';
...
$string['addquestionstoprogcontest'] = 'Add questions to current progcontest';
...
$string['addrandomquestiontoprogcontest'] = 'Add a random question to progcontest {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedquestionstoprogcontest'] = 'Add selected questions to the progcontest';
$string['addselectedtoprogcontest'] = 'Add selected to progcontest';
$string['addtoprogcontest'] = 'Add to progcontest';
...
$string['attempterror'] = 'You are not allowed to attempt this progcontest at this time because: {$a}';
$string['attempterrorinvalid'] = 'Invalid progcontest attempt ID';
$string['attempterrorcontentchange'] = 'This progcontest preview no longer exists. (When a progcontest is edited, any in-progress previews are automatically deleted.)';
$string['attempterrorcontentchangeforuser'] = 'This progcontest attempt no longer exists.';
$string['attemptfirst'] = 'First attempt';
$string['attemptincomplete'] = 'That attempt (by {$a}) is not yet completed.';
$string['attemptlast'] = 'Last attempt';
$string['attemptnumber'] = 'Attempt';
$string['attemptprogcontestnow'] = 'Attempt progcontest now';
...
$string['attemptsdeleted'] = 'Programmingcontest attempts deleted';
...
$string['autosaveperiod_desc'] = 'Responses can be saved automatically during progcontest attempts. The responses are saved whenever one is changed, and then after this delay. There is a trade-off: a shorter delay increases the server load, but reduces the chance that students lose their work. If you are going to make this delay much shorter, you should change the value gradually and monitor the server load. If the load gets too high, make the delay longer again. Setting the delay to 0 turns off auto-saving.';
$string['back'] = 'Back to preview question';
$string['backtocourse'] = 'Back to the course';
$string['backtoquestionlist'] = 'Back to question list';
$string['backtoprogcontest'] = 'Back to progcontest editing';
$string['basicideasofprogcontest'] = 'The basic ideas of progcontest-making';
...
* The progcontest will only start if the student has a JavaScript-enabled web-browser
* The progcontest appears in a full screen popup window that covers all the other windows and has no navigation controls
...
$string['cannoteditafterattempts'] = 'You cannot add or remove questions because this progcontest has been attempted. ({$a})';
...
$string['cannotsetgrade'] = 'Could not set a new maximum grade for the progcontest';
$string['cannotsetsumgrades'] = 'Failed to set sumgrades';
$string['cannotstartgradesmismatch'] = 'Cannot start an attempt at this progcontest. The progcontest is set to be graded out of {$a->grade}, but none of the questions in the progcontest have a grade. This can be fixed on the \'Edit progcontest\' page.';
$string['cannotstartmissingquestion'] = 'Cannot start an attempt at this progcontest. The progcontest definition includes a question that does not exist.';
$string['cannotstartnoquestions'] = 'Cannot start an attempt at this progcontest. The progcontest has not been set up yet. No questions have been added.';
$string['cannotwrite'] = 'Cannot write to export file ({$a})';
$string['canredoquestions'] = 'Allow redo within an attempt';
$string['canredoquestions_desc'] = 'If enabled, after finishing attempting a question, a \'Try another question like this one\' button is displayed. This allows for a similar question (selected randomly) to be attempted, or the same question again, without the entire progcontest attempt having to be submitted and another attempt started. This option is useful for practice progcontestzes.
...
$string['closebeforeopen'] = 'Could not update the progcontest. You have specified a close date before the open date.';
...
$string['completionpass_help'] = 'If enabled, this activity is considered complete when the student receives a pass grade (as specified in the Grade section of the progcontest settings) or higher.';
...
$string['completionattemptsexhausted_help'] = 'Mark progcontest complete when the student has exhausted the maximum number of attempts.';
$string['configadaptive'] = 'If you choose Yes for this option then the student will be allowed multiple responses to a question even within the same attempt at the progcontest.';
$string['configattemptsallowed'] = 'Restriction on the number of attempts students are allowed at the progcontest.';
$string['configdecimaldigits'] = 'Number of digits that should be shown after the decimal point when displaying grades.';
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the progcontest.';
...
$string['configdelay1'] = 'If you set a time delay, then a student has to wait for that time before they can attempt a progcontest after the first attempt.';
...
$string['configgrademethod'] = 'When multiple attempts are allowed, which method should be used to calculate the student\'s final grade for the progcontest.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new progcontest. You can also configure which progcontest settings are considered advanced.';
$string['configmaximumgrade'] = 'The default grade that the progcontest grade is scaled to be out of.';
$string['confignewpageevery'] = 'When adding questions to the progcontest page breaks will automatically be inserted according to the setting you choose here.';
...
$string['configoutcomesadvanced'] = 'If this option is turned on, then the Outcomes on the progcontest editing form are advanced settings.';
$string['configpenaltyscheme'] = 'Penalty subtracted for each wrong response in adaptive mode.';
$string['configpopup'] = 'Force the attempt to open in a popup window, and use JavaScript tricks to try to restrict copy and paste, etc. during progcontest attempts.';
$string['configrequirepassword'] = 'Students must enter this password before they can attempt the progcontest.';
$string['configrequiresubnet'] = 'Students can only attempt the progcontest from these computers.';
$string['configreviewoptions'] = 'These options control what information users can see when they review a progcontest attempt or look at the progcontest reports.';
$string['configshowblocks'] = 'Show blocks during progcontest attempts.';
$string['configshowuserpicture'] = 'Show the user\'s picture on screen during attempts.';
$string['configshufflewithin'] = 'If you enable this option, then the parts making up the individual questions will be randomly shuffled each time a student starts an attempt at this progcontest, provided the option is also enabled in the question settings.';
$string['configtimelimit'] = 'Default time limit for progcontestzes in minutes. 0 mean no time limit.';
$string['configtimelimitsec'] = 'Default time limit for progcontestzes in seconds. 0 mean no time limit.';
...
$string['continueattemptprogcontest'] = 'Continue your attempt';
...
$string['countdownfinished'] = 'The progcontest is closing, you should submit your answers now.';
$string['countdowntenminutes'] = 'The progcontest will be closing in ten minutes.';
...
$string['createmultiple'] = 'Add several random questions to progcontest';
$string['createnewquestion'] = 'Create new question';
$string['createquestionandadd'] = 'Create a new question and add it to the progcontest.';
...
$string['delaylater_help'] = 'If enabled, a student must wait for the specified time to elapse before attempting the progcontest a third time and any subsequent times.';
$string['delay1'] = 'Time delay between first and second attempt';
$string['delay1st2nd'] = 'Enforced delay between 1st and 2nd attempts';
$string['delay1st2nd_help'] = 'If enabled, a student must wait for the specified time to elapse before being able to attempt the progcontest a second time.';
...
$string['downloadextra'] = '(file is also stored in the course files in the /backupdata/progcontest folder)';
...
$string['eachattemptbuildsonthelast_help'] = 'If multiple attempts are allowed and this setting is enabled, each new progcontest attempt will contain the results of the previous attempt. This allows a progcontest to be completed over several attempts.';
$string['editcategories'] = 'Edit categories';
$string['editcategory'] = 'Edit category';
$string['editcatquestions'] = 'Edit category questions';
$string['editingquestion'] = 'Editing a question';
$string['editingprogcontest'] = 'Editing progcontest';
$string['editingprogcontest_help'] = 'When creating a progcontest, the main concepts are:

* The progcontest, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories
* Random questions -  A student gets different questions each time they attempt the progcontest and different students can get different questions';
$string['editingprogcontest_link'] = 'mod/progcontest/edit';
$string['editingprogcontestx'] = 'Editing progcontest: {$a}';
...
$string['editprogcontest'] = 'Edit progcontest';
$string['editprogcontestquestions'] = 'Edit progcontest questions';
$string['emailconfirmbody'] = 'Hi {$a->username},

Thank you for submitting your answers to \'{$a->progcontestname}\' in course \'{$a->coursename}\' at {$a->submissiontime}.

This message confirms that your answers have been saved.

You can access this progcontest at {$a->progcontesturl}.';
$string['emailconfirmsmall'] = 'Thank you for submitting your answers to \'{$a->progcontestname}\'';
$string['emailconfirmsubject'] = 'Submission confirmation: {$a->progcontestname}';
$string['emailnotifybody'] = 'Hi {$a->username},

{$a->studentname} has completed \'{$a->progcontestname}\' ({$a->progcontesturl}) in course \'{$a->coursename}\'.

You can review this attempt at {$a->progcontestreviewurl}.';
$string['emailnotifysmall'] = '{$a->studentname} has completed {$a->progcontestname}. See {$a->progcontestreviewurl}';
$string['emailnotifysubject'] = '{$a->studentname} has completed {$a->progcontestname}';
$string['emailoverduebody'] = 'Hi {$a->studentname},

You started an attempt at \'{$a->progcontestname}\' in course \'{$a->coursename}\', but you never submitted it. It should have been submitted by {$a->attemptduedate}.
...
$string['emailoverduesmall'] = 'You did not submit your attempt at {$a->progcontestname}. Please go to {$a->attemptsummaryurl} before {$a->attemptgraceend} if you would still like to submit.';
$string['emailoverduesubject'] = 'Attempt now overdue: {$a->progcontestname}';
$string['empty'] = 'Empty';
...
$string['eventattemptdeleted'] = 'Programmingcontest attempt deleted';
$string['eventattemptpreviewstarted'] = 'Programmingcontest attempt preview started';
$string['eventattemptreviewed'] = 'Programmingcontest attempt reviewed';
$string['eventattemptsummaryviewed'] = 'Programmingcontest attempt summary viewed';
$string['eventattemptviewed'] = 'Programmingcontest attempt viewed';
$string['eventeditpageviewed'] = 'Programmingcontest edit page viewed';
$string['eventoverridecreated'] = 'Programmingcontest override created';
$string['eventoverridedeleted'] = 'Programmingcontest override deleted';
$string['eventoverrideupdated'] = 'Programmingcontest override updated';
$string['eventquestionmanuallygraded'] = 'Question manually graded';
$string['eventprogcontestattemptabandoned'] = 'Programmingcontest attempt abandoned';
$string['eventprogcontestattempttimelimitexceeded'] = 'Programmingcontest attempt time limit exceeded';
$string['eventprogcontestattemptregraded'] = 'Programmingcontest attempt regraded';
$string['eventprogcontestattemptstarted'] = 'Programmingcontest attempt started';
$string['eventprogcontestattemptsubmitted'] = 'Programmingcontest attempt submitted';
$string['eventreportviewed'] = 'Programmingcontest report viewed';
...
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the progcontest. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the progcontest when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this long after time expires, so they are not penalised for the server being slow. However, the student could cheat and get this many seconds to answer the progcontest. You have to make a trade-off based on how much you trust the performance of your server during progcontestzes.';
...
$string['grademethod_help'] = 'When multiple attempts are allowed, the following methods are available for calculating the final progcontest grade:

* Highest grade of all attempts
* Average (mean) grade of all attempts
* First attempt (all other attempts are ignored)
* Last attempt (all other attempts are ignored)';
$string['gradesdeleted'] = 'Programmingcontest grades deleted';
$string['gradesofar'] = '{$a->method}: {$a->mygrade} / {$a->progcontestgrade}.';
$string['gradetopassnotset'] = 'This progcontest does not yet have a grade to pass set. It may be set in the Grade section of the progcontest settings.';
$string['gradetopassmustbeset'] = 'Grade to pass cannot be zero as this progcontest has its completion method set to require passing grade. Please set a non-zero value.';
...
$string['guestsno'] = 'Sorry, guests cannot see or attempt progcontestzes';
$string['hidebreaks'] = 'Hide page breaks';
$string['hidereordertool'] = 'Hide the reordering tool';
$string['history'] = 'History of responses:';
$string['howquestionsbehave_desc'] = 'Default setting for how questions behave in a progcontest.';
...
$string['indicator:cognitivedepth'] = 'Programmingcontest cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a Programmingcontest activity.';
$string['indicator:cognitivedepthdef'] = 'Programmingcontest cognitive';
$string['indicator:cognitivedepthdef_help'] = 'The participant has reached this percentage of the cognitive engagement offered by the Programmingcontest activities during this analysis interval (Levels = No view, View, Submit, View feedback, Comment on feedback, Resubmit after viewing feedback)';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = 'Programmingcontest social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a Programmingcontest activity.';
$string['indicator:socialbreadthdef'] = 'Programmingcontest social';
$string['indicator:socialbreadthdef_help'] = 'The participant has reached this percentage of the social engagement offered by the Programmingcontest activities during this analysis interval (Levels = No participation, Participant alone, Participant with others)';
...
$string['initialnumfeedbacks_desc'] = 'When creating a new progcontest, provide this many blank overall feedback boxes. Once the progcontest has been created, the form shows the number of fields required for the number of feedbacks in the progcontest. The setting must be at least 1.';
...
$string['invalidprogcontestid'] = 'Invalid progcontest ID';
...
$string['legacyprogcontestaccessrulescron'] = 'Legacy cron progcontest access rules';
$string['legacyprogcontestreportscron'] = 'Legacy cron progcontest reports';
$string['link'] = 'Link';
$string['listitems'] = 'Listing of items in progcontest';
...
$string['manualgradequestion'] = 'Manually grade question {$a->question} in {$a->progcontest} by {$a->user}';
$string['mark'] = 'Submit';
...
$string['messageprovider:attempt_overdue'] = 'Warning when your progcontest attempt becomes overdue';
$string['messageprovider:confirmation'] = 'Confirmation of your own progcontest submissions';
$string['messageprovider:submission'] = 'Notification of your students\' progcontest submissions';
$string['max'] = 'Max';
...
Programmingcontestzes may be used
...
* For self-assessment';
$string['modulename_link'] = 'mod/progcontest/view';
$string['modulenameplural'] = 'Programmingcontestzes';
...
$string['navmethod_help'] = 'When sequential navigation is enabled a student must progress through the progcontest in order and may not return to previous pages nor skip ahead.';
...
$string['newattemptfail'] = 'Error: Could not start a new attempt at the progcontest';
$string['newcategory'] = 'New category';
$string['newpage'] = 'New page';
$string['newpage_help'] = 'For longer progcontestzes it makes sense to stretch the progcontest over several pages by limiting the number of questions per page. When adding questions to the progcontest, page breaks will automatically be inserted according to this setting. However page breaks may later be moved manually on the editing page.';
...
$string['noattempts'] = 'No attempts have been made on this progcontest';
...
$string['nogradewarning'] = 'This progcontest is not graded, so you cannot set overall feedback that differs by grade.';
$string['nomoreattempts'] = 'No more attempts are allowed';
$string['none'] = 'None';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the progcontest settings.';
...
$string['noquestionsinprogcontest'] = 'There are no questions in this progcontest.';
...
$string['noreview'] = 'You are not allowed to review this progcontest';
$string['noreviewattempt'] = 'You are not allowed to review this attempt.';
$string['noreviewshort'] = 'Not permitted';
$string['noreviewuntil'] = 'You are not allowed to review this progcontest until {$a}';
$string['noreviewuntilshort'] = 'Available {$a}';
$string['noscript'] = 'JavaScript must be enabled to continue!';
$string['notavailabletostudents'] = 'Note: This progcontest is not currently available to your students';
...
$string['notimedependentitems'] = 'Time dependent items are not currently supported by the progcontest module. As a work around, set a time limit for the whole progcontest. Do you wish to choose a different item (or use the current item regardless)?';
$string['notyetgraded'] = 'Not yet graded';
$string['notyetviewed'] = 'Not yet viewed';
$string['notyourattempt'] = 'This is not your attempt!';
$string['noview'] = 'Logged-in user is not allowed to view this progcontest';
...
$string['openafterclose'] = 'Could not update the progcontest. You have specified an open date after the close date.';
$string['openclosedatesupdated'] = 'Programmingcontest open and close dates updated';
...
$string['orderingprogcontest'] = 'Order and paging';
$string['orderingprogcontestx'] = 'Order and paging: {$a}';
...
$string['overallfeedback_help'] = 'Overall feedback is text that is shown after a progcontest has been attempted. By specifying additional grade boundaries (as a percentage or as a number), the text shown can depend on the grade obtained.';
$string['overdue'] = 'Overdue';
$string['overduehandling'] = 'When time expires';
$string['overduehandling_desc'] = 'What should happen by default if a student does not submit the progcontest before time expires.';
$string['overduehandling_help'] = 'This setting controls what happens if a student fails to submit their progcontest attempt before the time expires. If the student is actively working on the progcontest at the time, then the countdown timer will always automatically submit the attempt for them, but if they have logged out, then this setting controls what happens.';
$string['overduehandling_link'] = 'mod/progcontest/timing';
...
$string['overduemustbesubmittedby'] = 'This attempt is now overdue. It should already have been submitted. If you would like this progcontest to be graded, you must submit it by {$a}. If you do not submit it by then, no marks from this attempt will be counted.';
...
$string['overridegroupeventname'] = '{$a->progcontest} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overridesforprogcontest'] = 'Settings overrides: {$a}';
$string['overridesnoneforgroups'] = 'No group settings overrides have been created for this progcontest.';
$string['overridesnoneforusers'] = 'No user settings overrides have been created for this progcontest.';
...
$string['overrideusereventname'] = '{$a->progcontest} - Override';
$string['pageshort'] = 'P';
$string['page-mod-progcontest-x'] = 'Any progcontest module page';
$string['page-mod-progcontest-attempt'] = 'Attempt progcontest page';
$string['page-mod-progcontest-edit'] = 'Edit progcontest page';
$string['page-mod-progcontest-report'] = 'Any progcontest report page';
$string['page-mod-progcontest-review'] = 'Review progcontest attempt page';
$string['page-mod-progcontest-summary'] = 'Programmingcontest attempt summary page';
$string['page-mod-progcontest-view'] = 'Programmingcontest information page';
...
$string['pluginadministration'] = 'Programmingcontest administration';
$string['pluginname'] = 'Programming contest';
$string['popup'] = 'Show progcontest in a \'secure\' window';
$string['popupblockerwarning'] = 'This section of the test is in secure mode, this means that you need to take the progcontest in a secure window. Please turn off your popup blocker. Thank you.';
$string['popupnotice'] = 'Students will see this progcontest in a secure window';
$string['preprocesserror'] = 'Error occurred during pre-processing!';
$string['preview'] = 'Preview';
$string['previewquestion'] = 'Preview question';
$string['previewprogcontest'] = 'Preview {$a}';
$string['previewprogcontestnow'] = 'Preview progcontest now';
$string['previous'] = 'Previous state';
$string['privacy:metadata:core_question'] = 'The progcontest activity stores question usage information in the core_question subsystem.';
$string['privacy:metadata:progcontest'] = 'The progcontest activity makes use of progcontest reports.';
$string['privacy:metadata:progcontest_attempts'] = 'Details about each attempt on a progcontest.';
$string['privacy:metadata:progcontest_attempts:attempt'] = 'The attempt number.';
$string['privacy:metadata:progcontest_attempts:currentpage'] = 'The current page that the user is on.';
$string['privacy:metadata:progcontest_attempts:preview'] = 'Whether this is a preview of the progcontest.';
$string['privacy:metadata:progcontest_attempts:state'] = 'The current state of the attempt.';
$string['privacy:metadata:progcontest_attempts:sumgrades'] = 'The sum of grades in the attempt.';
$string['privacy:metadata:progcontest_attempts:timecheckstate'] = 'The time that the state was checked.';
$string['privacy:metadata:progcontest_attempts:timefinish'] = 'The time that the attempt was completed.';
$string['privacy:metadata:progcontest_attempts:timemodified'] = 'The time that the attempt was updated.';
$string['privacy:metadata:progcontest_attempts:timemodifiedoffline'] = 'The time that the attempt was updated via an offline update.';
$string['privacy:metadata:progcontest_attempts:timestart'] = 'The time that the attempt was started.';
$string['privacy:metadata:progcontest_grades'] = 'Details about the overall grade for this progcontest.';
$string['privacy:metadata:progcontest_grades:grade'] = 'The overall grade for this progcontest.';
$string['privacy:metadata:progcontest_grades:progcontest'] = 'The progcontest that was graded.';
$string['privacy:metadata:progcontest_grades:timemodified'] = 'The time that the grade was modified.';
$string['privacy:metadata:progcontest_grades:userid'] = 'The user who was graded.';
$string['privacy:metadata:progcontest_overrides'] = 'Details about overrides for this progcontest';
$string['privacy:metadata:progcontest_overrides:progcontest'] = 'The progcontest with override information';
$string['privacy:metadata:progcontest_overrides:timeclose'] = 'The new close time for the progcontest.';
$string['privacy:metadata:progcontest_overrides:timelimit'] = 'The new time limit for the progcontest.';
$string['privacy:metadata:progcontest_overrides:timeopen'] = 'The new open time for the progcontest.';
$string['privacy:metadata:progcontest_overrides:userid'] = 'The user being overridden';
$string['privacy:metadata:progcontestaccess'] = 'The progcontest activity makes use of progcontest access rules.';
...
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->progcontestnames}<br />The question will not be deleted from these progcontestzes but only from the category list.';
...
$string['questionsinthisprogcontest'] = 'Questions in this progcontest';
...
$string['progcontest:addinstance'] = 'Add a new progcontest';
$string['progcontest:attempt'] = 'Attempt progcontestzes';
$string['progcontestavailable'] = 'The progcontest is available until: {$a}';
$string['progcontestclose'] = 'Close the progcontest';
$string['progcontestclosed'] = 'This progcontest closed on {$a}';
$string['progcontestcloses'] = 'Programmingcontest closes';
$string['progcontesteventcloses'] = '{$a} closes';
$string['progcontestcloseson'] = 'This progcontest will close on {$a}.';
$string['progcontest:deleteattempts'] = 'Delete progcontest attempts';
$string['progcontest:emailconfirmsubmission'] = 'Receive confirmation of your own progcontest submissions';
$string['progcontest:emailnotifysubmission'] = 'Receive notification of your students\' progcontest submissions';
$string['progcontest:emailwarnoverdue'] = 'Receive warning when your progcontest attempt becomes overdue';
$string['progcontest:grade'] = 'Grade progcontestzes manually';
$string['progcontest:ignoretimelimits'] = 'Ignore progcontest time limit';
$string['progcontestisclosed'] = 'This progcontest is closed';
$string['progcontestisopen'] = 'This progcontest is open';
$string['progcontestisclosedwillopen'] = 'Programmingcontest closed (opens {$a})';
$string['progcontestisopenwillclose'] = 'Programmingcontest open (closes {$a})';
$string['progcontest:manage'] = 'Manage progcontestzes';
$string['progcontest:manageoverrides'] = 'Manage progcontest settings overrides';
$string['progcontest:viewoverrides'] = 'View progcontest settings overrides';
$string['progcontestnavigation'] = 'Programmingcontest navigation';
$string['progcontestopen'] = 'Open the progcontest';
$string['progcontesteventopens'] = '{$a} opens';
$string['progcontestopenclose'] = 'Open and close dates';
$string['progcontestopenclose_help'] = 'Students can only start their attempt(s) after the open time and they must complete their attempts before the close time.';
$string['progcontestopenclose_link'] = 'mod/progcontest/timing';
$string['progcontestopened'] = 'This progcontest is open.';
$string['progcontestopenedon'] = 'This progcontest opened on {$a}';
$string['progcontestopens'] = 'Programmingcontest opens';
$string['progcontestopenwillclose'] = 'This progcontest is open, will close on {$a} at';
$string['progcontestordernotrandom'] = 'Order of progcontest not shuffled';
$string['progcontestorderrandom'] = '* Order of progcontest is shuffled';
$string['progcontest:preview'] = 'Preview progcontestzes';
$string['progcontest:regrade'] = 'Regrade progcontest attempts';
$string['progcontestreport'] = 'Programmingcontest report';
$string['progcontest:reviewmyattempts'] = 'Review your own attempts';
$string['progcontestsettings'] = 'Programmingcontest settings';
$string['progcontest:view'] = 'View progcontest information';
$string['progcontest:viewreports'] = 'View progcontest reports';
$string['progcontesttimer'] = 'Programmingcontest Timer';
$string['progcontestwillopen'] = 'This progcontest will open {$a}';
...
$string['readytosend'] = 'You are about to send your whole progcontest to be graded.  Are you sure you want to continue?';
$string['reattemptprogcontest'] = 'Re-attempt progcontest';
...
$string['regradenotallowed'] = 'You do not have permission to regrade this progcontest';
$string['regradingquestion'] = 'Regrading "{$a}".';
$string['regradingprogcontest'] = 'Regrading progcontest "{$a}"';
$string['remove'] = 'Remove';
$string['removeallgroupoverrides'] = 'Delete all group overrides';
$string['removeallprogcontestattempts'] = 'Delete all progcontest attempts';
...
$string['reportusersall'] = 'all users who have attempted the progcontest';
$string['reportuserswith'] = 'enrolled users who have attempted the progcontest';
$string['reportuserswithorwithout'] = 'enrolled users who have, or have not, attempted the progcontest';
$string['reportuserswithout'] = 'enrolled users who have not attempted the progcontest';
$string['reportwhattoinclude'] = 'What to include in the report';
$string['requirepassword'] = 'Require password';
$string['requirepassword_help'] = 'If a password is specified, a student must enter it in order to attempt the progcontest.';
$string['requiresubnet'] = 'Require network address';
$string['requiresubnet_help'] = 'Programmingcontest access may be restricted to particular subnets on the LAN or Internet by specifying a comma-separated list of partial or full IP address numbers. This can be useful for an invigilated (proctored) progcontest, to ensure that only people in a certain location can access the progcontest.';
$string['response'] = 'Response';
$string['responses'] = 'Responses';
$string['results'] = 'Results';
$string['returnattempt'] = 'Return to attempt';
$string['reuseifpossible'] = 'reuse previously removed';
$string['reverttodefaults'] = 'Revert to progcontest defaults';
$string['review'] = 'Review';
$string['reviewafter'] = 'Allow review after progcontest is closed';
$string['reviewalways'] = 'Allow review at any time';
$string['reviewattempt'] = 'Review attempt';
$string['reviewbefore'] = 'Allow review while progcontest is open';
$string['reviewclosed'] = 'After the progcontest is closed';
...
$string['reviewofquestion'] = 'Review of question {$a->question} in {$a->progcontest} by {$a->user}';
$string['reviewopen'] = 'Later, while the progcontest is still open';
$string['reviewoptions'] = 'Students may review';
$string['reviewoptionsheading'] = 'Review options';
$string['reviewoptionsheading_help'] = 'These options control what information students can see when they review a progcontest attempt or look at the progcontest reports.
...
**Later, while the progcontest is still open** settings apply after this, and before the progcontest close date.

**After the progcontest is closed** settings apply after the progcontest close date has passed. If the progcontest does not have a close date, this state is never reached.';
...
$string['saveattemptfailed'] = 'Failed to save the current progcontest attempt.';
...
$string['saveprogcontest'] = 'Save this whole progcontest';
...
$string['search:activity'] = 'Programmingcontest - activity information';
...
$string['showblocks'] = 'Show blocks during progcontest attempts';
$string['showblocks_help'] = 'If set to yes then normal blocks will be shown during progcontest attempts';
...
$string['shufflequestions_help'] = 'If enabled, every time the progcontest is attempted, the order of the questions in this section will be shuffled into a different random order.
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time a student attempts the progcontest, provided the option is also enabled in the question settings. This setting only applies to questions that have multiple parts, such as multiple choice or matching questions.';
...
$string['specificquestionnotonprogcontest'] = 'Specified question is not on the specified progcontest';
...
$string['subneterror'] = 'Sorry, this progcontest has been locked so that it is only accessible from certain locations.  Currently your computer is not one of those allowed to use this progcontest.';
$string['subnetnotice'] = 'This progcontest has been locked so that it is only accessible from certain locations. Your computer is not on an allowed subnet. As teacher you are allowed to preview anyway.';
$string['subplugintype_progcontest'] = 'Report';
$string['subplugintype_progcontest_plural'] = 'Reports';
$string['subplugintype_progcontestaccess'] = 'Access rule';
$string['subplugintype_progcontestaccess_plural'] = 'Access rules';
...
$string['temporaryblocked'] = 'You are temporarily not allowed to re-attempt the progcontest.<br /> You will be able to take another attempt on:';
$string['theattempt'] = 'The attempt';
$string['theattempt_help'] = 'Whether the student can review the attempt at all.';
$string['time'] = 'Time';
$string['timecompleted'] = 'Completed';
$string['timedelay'] = 'You are not allowed to do the progcontest since you have not passed the time delay before attempting another progcontest';
$string['timeleft'] = 'Time left';
$string['timelimit'] = 'Time limit';
$string['timelimit_help'] = 'If enabled, the time limit is stated on the initial progcontest page and a countdown timer is displayed in the progcontest navigation block.';
$string['timelimit_link'] = 'mod/progcontest/timing';
$string['timelimitexeeded'] = 'Sorry! Programmingcontest time limit exceeded!';
...
$string['updateoverdueattemptstask'] = 'Updating overdue progcontest attempts';
$string['updatesettings'] = 'Update progcontest settings';
$string['updateprogcontestslotswithrandomxofy'] = 'Updating progcontest slots with "random" question data ({$a->done}/{$a->total})';
...
$string['upgradesure'] = '<div>In particular the progcontest module will perform an extensive change of the progcontest tables and this upgrade has not yet been sufficiently tested. You are very strongly urged to backup your database tables before proceeding.</div>';
$string['upgradingprogcontestattempts'] = 'Upgrading progcontest attempts: progcontest {$a->done}/{$a->outof} (Programmingcontest id {$a->info})';
$string['upgradingveryoldprogcontestattempts'] = 'Upgrading very old progcontest attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
...
$string['usersnone'] = 'No students have access to this progcontest';
$string['validate'] = 'Validate';
$string['viewallanswers'] = 'View {$a} progcontest attempts';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'You need to enrol in this course before you can attempt this progcontest';
$string['yourfinalgradeis'] = 'Your final grade for this progcontest is {$a}.';

// Deprecated since Moodle 3.8.
$string['numattemptsmade'] = '{$a} attempts made on this progcontest';
...
$string['invalidquestiontype'] = 'Le type de question « {$a} » n\'est pas autorisé dans cette activité.';
