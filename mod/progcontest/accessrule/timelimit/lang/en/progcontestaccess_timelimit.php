...
/**
 * Strings for the progcontestaccess_timelimit plugin.
 *
...
$string['pluginname'] = 'Time limit progcontest access rule';
$string['privacy:metadata'] = 'The Time limit progcontest access rule plugin does not store any personal data.';
$string['progcontesttimelimit'] = 'Time limit: {$a}';
