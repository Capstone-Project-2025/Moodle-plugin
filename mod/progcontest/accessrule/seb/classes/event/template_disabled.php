...
class template_disabled extends base {
    ...
    protected function init() {
        $this->data['objecttable'] = 'seb_template';
        $this->data['crud'] = 'u';
    ...
    public static function get_name() {
        return get_string('event:templatedisabled', 'progcontestaccess_seb');
    }
    ...
    public function get_url() {
        ...
        return new \moodle_url('/mod/progcontest/accessrule/seb/template.php', $params);
    }
    ...
    public static function get_objectid_mapping() : array {
        return array('db' => 'seb_template', 'restore' => 'seb_template');
    }
