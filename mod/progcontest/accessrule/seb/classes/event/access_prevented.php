...
/**
 * Event for when access to a progcontest is prevented by this subplugin.
 *
...
class access_prevented extends base {
    ...
    public static function create_strict(access_manager $accessmanager, string $reason) : base {
        ...
        return self::create([
            'userid' => $USER->id,
            'objectid' => $accessmanager->get_progcontest()->get_progcontestid(),
            'courseid' => $accessmanager->get_progcontest()->get_courseid(),
            'context' => $accessmanager->get_progcontest()->get_context(),
            'other' => $other,
        ]);
    }
    ...
    protected function init() {
        $this->data['objecttable'] = 'progcontest';
        $this->data['crud'] = 'r';
    ...
    public static function get_name() {
        return get_string('event:accessprevented', 'progcontestaccess_seb');
    }
    ...
    public function get_description() {
        $description = "The user with id '$this->userid' has been prevented from accessing progcontest with id '$this->objectid' by the "
    ...
    public static function get_objectid_mapping() : array {
        return array('db' => 'progcontest', 'restore' => 'progcontest');
    }
