...
use core\notification;
use progcontestaccess_seb\local\table\template_list;
...
class template_controller {
    ...
    protected function set_external_page() {
        admin_externalpage_setup('progcontestaccess_seb/template');
    }
     ...
     *
     * @return \progcontestaccess_seb\template
     */
    ...
    protected function get_create_button_text() : string {
        return get_string('addtemplate', 'progcontestaccess_seb');
    }

    /**
     * Returns form for the record.
     *
     * @param \progcontestaccess_seb\template|null $instance
     *
     * @return \progcontestaccess_seb\local\form\template
     */
    protected function get_form($instance) : \progcontestaccess_seb\local\form\template {
        global $PAGE;

        return new \progcontestaccess_seb\local\form\template($PAGE->url->out(false), ['persistent' => $instance]);
    }
    ...
    protected function get_view_heading() : string {
        return get_string('managetemplates', 'progcontestaccess_seb');
    }
    ...
    protected function get_new_heading() : string {
        return get_string('newtemplate', 'progcontestaccess_seb');
    }
    ...
    protected function get_edit_heading() : string {
        return get_string('edittemplate', 'progcontestaccess_seb');
    }
    ...
    public static function get_base_url() : string {
        return '/mod/progcontest/accessrule/seb/template.php';
    }
        ...
        if ($form->is_cancelled()) {
            ...
            try {
                if (empty($data->id)) {
                    ...
                    \progcontestaccess_seb\event\template_created::create_strict(
                        $persistent,
                    ...
                    \progcontestaccess_seb\event\template_updated::create_strict(
                        $instance,
                        \context_system::instance()
                    )->trigger();
            ...
            if (empty($instance)) {
                ...
                if (!$instance->can_delete()) {
                    notification::warning(get_string('cantedit', 'progcontestaccess_seb'));
                }
    ...
    protected function delete($id) {
        ...
        if ($instance->can_delete()) {
            ...
            \progcontestaccess_seb\event\template_deleted::create_strict(
                $id,
                \context_system::instance()
            )->trigger();
            ...
            notification::warning(get_string('cantdelete', 'progcontestaccess_seb'));
            redirect(new \moodle_url(static::get_base_url()));
        }
    }
    ...
    protected function view() {
        ...
        $PAGE->requires->js_call_amd('progcontestaccess_seb/managetemplates', 'setup');
    ...
    private function trigger_enabled_event(template $template) {
        ...
        $func = '\progcontestaccess_seb\event\template_' . $eventstring;
        $func::create_strict(
            $template,
            \context_system::instance()
        )->trigger();
