...
namespace progcontestaccess_seb\local\table;

use progcontestaccess_seb\helper;
use progcontestaccess_seb\template;
use progcontestaccess_seb\template_controller;
...
class template_list extends \flexible_table {
    ...
    public function __construct($id = null) {
        ...
        parent::__construct('progcontestaccess_seb' . $id);
        ...
        $this->define_headers([
            get_string('name', 'progcontestaccess_seb'),
            get_string('description', 'progcontestaccess_seb'),
            get_string('enabled', 'progcontestaccess_seb'),
            get_string('used', 'progcontestaccess_seb'),
            get_string('actions'),
        ]);
     ...
     * Display name column.
     *
     * @param \progcontestaccess_seb\template $data Template for this row.
     * @return string
     */
     ...
     *
     * @param \progcontestaccess_seb\template[] $records An array with records.
     */
