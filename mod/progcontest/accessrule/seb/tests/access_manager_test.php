...
class access_manager_test extends \advanced_testcase {
    ...
    /**
     * Test access_manager private property progcontestsettings is null.
     */
    public function test_access_manager_progcontestsettings_null() {
        ...
        $reflection = new \ReflectionClass('\progcontestaccess_seb\access_manager');
        $property = $reflection->getProperty('progcontestsettings');
    ...
    /**
     * Test that the progcontest Config Key matches the incoming request header.
     */
    public function test_access_keys_validate_with_config_key() {
        ...
        $configkey = progcontest_settings::get_record(['progcontestid' => $this->progcontest->id])->get_config_key();
    ...
    /**
     * Test that the progcontest Config Key does not match the incoming request header.
     */
    ...
    /**
     * Test that if there are no browser exam keys for progcontest, check is skipped.
     */
    ...
    /**
     * Test can correctly get type of SEB usage for the progcontest.
     */
    ...
    public function test_access_manager_uses_cached_config_key() {
        ...
        $this->assertNotEquals($progcontestsettings->get_config_key(), $configkey);
        $this->assertTrue($accessmanager->validate_config_key());
    ...
    /**
     * Check that valid SEB config key is null if progcontest doesn't have SEB settings.
     */
    public function test_valid_config_key_is_null_if_no_settings() {
        ...
        $this->assertEmpty(progcontest_settings::get_record(['progcontestid' => $this->progcontest->id]));
