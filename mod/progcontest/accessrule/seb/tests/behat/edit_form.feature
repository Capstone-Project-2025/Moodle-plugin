@javascript @mod_progcontest @progcontestaccess @progcontestaccess_seb
Feature: Safe Exam Browser settings in progcontest edit form
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | progcontest     | C1     | 1       | Programmingcontest 1 |

  Scenario: Programmingcontest setting "Require the use of Safe Exam Browser" has all types, except "Use an existing template".
    When I am on the "Programmingcontest 1" "progcontest activity editing" page logged in as admin
  ...
  Scenario: Programmingcontest setting "Require the use of Safe Exam Browser" has all types if at least one template has been added.
    Given the following "progcontestaccess_seb > seb templates" exist:
      | name       |
      | Template 1 |
    When I am on the "Programmingcontest 1" "progcontest activity editing" page logged in as admin
    And I expand all fieldsets
  ...
  Scenario: SEB settings if using Use SEB client config
    Given the following "progcontestaccess_seb > seb templates" exist:
      | name       |
      | Template 1 |
    And I am on the "Programmingcontest 1" "progcontest activity editing" page logged in as admin
    And I expand all fieldsets
