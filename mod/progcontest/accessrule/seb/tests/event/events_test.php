...
namespace progcontestaccess_seb\event;
...
class events_test extends \advanced_testcase {
    ...
    public function test_event_access_prevented() {
        ...
        $this->setAdminUser();
        $progcontest = $this->create_test_progcontest($this->course, \progcontestaccess_seb\settings_provider::USE_SEB_CONFIG_MANUALLY);
        $accessmanager = new \progcontestaccess_seb\access_manager(new progcontest($progcontest,
            get_coursemodule_from_id('progcontest', $progcontest->cmid), $this->course));
        ...
        $event = \progcontestaccess_seb\event\access_prevented::create_strict($accessmanager, 'Because I said so.');
        ...
        $this->assertEquals('Programmingcontest access was prevented', $event->get_name());
        $this->assertEquals(
            "The user with id '$user->id' has been prevented from accessing progcontest with id '$progcontest->id' by the "
        ...
        $this->assertEquals($progcontest->id, $event->objectid);
    ...
    public function test_event_create_template() {
        ...
        $event = \progcontestaccess_seb\event\template_created::create_strict(
            $template,
        ...
        // Test that the event data is as expected.
        $this->assertInstanceOf('\progcontestaccess_seb\event\template_created', $event);
