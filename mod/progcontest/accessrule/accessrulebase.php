...
/**
 * Base class for rules that restrict the ability to attempt a progcontest.
 *
...
/**
 * A base class that defines the interface for the various progcontest access rules.
 ...
 * @since     Moodle 2.2
 */
abstract class progcontest_access_rule_base {
    /** @var stdClass the progcontest settings. */
    protected $progcontest;
    /** @var progcontest the progcontest object. */
     ...
     */
    public function __construct($progcontestobj, $timenow) {
        $this->progcontestobj = $progcontestobj;
        $this->progcontest = $progcontestobj->get_progcontest();
     ...
     *
     * @param mod_progcontest_preflight_check_form $progcontestform the form being built.
    ...
    /**
     * This is called when the current attempt at the progcontest is finished. This is
     ...
     * this progcontest, then return true. This is used so we can know whether to display a
    ...
    /**
     * @return array key => lang string any choices to add to the progcontest Browser
     ...
     */
    public static function get_settings_sql($progcontestid) {
        return array('', '', array());
    }
     ...
     */
    public static function get_extra_settings($progcontestid) {
        return array();
    }
}
