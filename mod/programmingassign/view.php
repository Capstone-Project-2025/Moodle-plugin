...
// ---------- GRADING SUMMARY ----------
    ...
    echo html_writer::end_tag('table');
        ...
        echo html_writer::start_tag('form', [
            'method' => 'post',
            'action' => new moodle_url('/mod/programmingassign/submit.php', ['id' => $id]),
        ]);
    
        echo html_writer::start_div('form-group');
        echo html_writer::tag('label', 'Your Answer:', ['for' => 'usertext']);
        ...
        echo html_writer::empty_tag('br');
        echo html_writer::tag('button', 'Submit', ['type' => 'submit', 'class' => 'btn btn-primary']);
