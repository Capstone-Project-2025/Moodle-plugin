...
function xmldb_qtype_programming_upgrade($oldversion) {
    ...
    if ($oldversion < 2025070205) {
        ...
        $table->add_key('problemidfk', XMLDB_KEY_FOREIGN, ['problem_id'], 'local_programming_problem', ['id']);
        ...
        */
        ...
        $table->add_key('languagefk', XMLDB_KEY_FOREIGN, ['language_id'], 'local_programming_language', ['id']);
