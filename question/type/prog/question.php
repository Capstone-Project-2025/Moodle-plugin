...
/**
 * Defines the behavior and grading logic for the prog question type.
 */
class qtype_prog_question extends question_graded_automatically {
    ...
    public function get_validation_error(array $response) {
        if (!$this->is_complete_response($response)) {
            return get_string('pleaseenterananswer', 'qtype_prog');
        }
        return null;
    }
   ...
   $record = $DB->get_record('qtype_prog_submission', ['submission_id' => $submissionid]);
