...
require_once($CFG->dirroot . '/question/type/prog/question.php');

/**
 * Handles serving of files used in prog questions.
 *
 ...
 */
function qtype_prog_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    return false;
}
